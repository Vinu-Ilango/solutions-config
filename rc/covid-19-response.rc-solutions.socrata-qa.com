      ...
      "view_entries": [
        {
          ...
          "parent_queries": [
            ...
            "SELECT date, country_region, province_state, type, count, geocoded_column, delta, :@computed_region_mquc_phjc, :@computed_region_mpe2_7au2, :@computed_region_ctwz_r3ic, :@computed_region_xck7_iyzd WHERE type = 'Confirmed'"
          ],
          "column": "delta",
          "start_date_override_and_ignore": "true",
          "aggregate_type": "sum",
